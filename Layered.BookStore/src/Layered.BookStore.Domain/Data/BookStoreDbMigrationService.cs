...
public class BookStoreDbMigrationService(
    ...
    IEnumerable<IBookStoreDbSchemaMigrator> dbSchemaMigrators) : ITransientDependency
{
    ...
    private readonly IEnumerable<IBookStoreDbSchemaMigrator> _dbSchemaMigrators = dbSchemaMigrators;
